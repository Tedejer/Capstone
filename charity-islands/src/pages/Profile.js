...
function Profile() {
    ...
    <div class="row mt-3">
        <div class="col-md-12">
            ...
            <input type="text"class="form-control"placeholder="JohnDoe"value=""/>
        </div>
    </div>
    ...
    <div class="row mt-3">
        <div class="col-md-12">
            ...
            <input type="text"class="form-control"placeholder="Upload Profile Picture"value=""/>
        </div>
    </div>

    <div class="mt-3 text-center">
        <button class="btn btn-primary profile-button" type="button">Upload</button>
        </div>
    </div>
    );
}
